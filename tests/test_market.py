...
with warnings.catch_warnings():
    ...
    from covShrinkage.covMarket import covMarket

from covShrinkage.market import MarketShrinkage
...
def test_twoParams_shrinkage(data_file: str, reference_file: str) -> None:
    ...
    raise NotImplementedError("MarketShrinkage is not implemented yet.")

    S_hat = MarketShrinkage().fit(X).covariance
    S_hat_1 = covMarket(pd.DataFrame(X))
