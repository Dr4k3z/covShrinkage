...
with warnings.catch_warnings():
    ...
    from covShrinkage.covCor import covCor

from covShrinkage.corr import CorrelationShrinkage
...
def test_twoParams_shrinkage(data_file: str, reference_file: str) -> None:
    ...
    raise NotImplementedError("CorrelationShrinkage not implemented yet.")

    S_hat = CorrelationShrinkage().fit(X).covariance
    S_hat_1 = covCor(pd.DataFrame(X))
